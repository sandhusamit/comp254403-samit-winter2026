...
//
//  public static <E> LinkedQueue<E> mergeQueue(LinkedQueue<E> Q1, LinkedQueue<E> Q2, Comparator<E> comp) {
...
//  }
//
//  public static <E> LinkedQueue<E> bottomUpMergeSort(Queue<E> input, Comparator<E> comp) {
//
//    LinkedQueue<LinkedQueue<E>> QueOfQues = new LinkedQueue<>();
//    //run until we have only one combined que inside the Que of Ques -> goes from n ques, to 1 through looping and using two ques in each iteration calling the merge method
//    while (QueOfQues.size() > 1) {
//      LinkedQueue<E> q1 = QueOfQues.dequeue(); //deque to update the que of ques with the merged
//      LinkedQueue<E> q2 = QueOfQues.dequeue(); //adjacent que to be compared and merged
//
//      LinkedQueue<E> mergedQue = mergeQueue(q1, q2, comp);
//      //Final Update of Que of Ques
//      QueOfQues.enqueue(mergedQue);
//    }
//
//    return QueOfQues.dequeue(); //only one left.
//
//  }
//
