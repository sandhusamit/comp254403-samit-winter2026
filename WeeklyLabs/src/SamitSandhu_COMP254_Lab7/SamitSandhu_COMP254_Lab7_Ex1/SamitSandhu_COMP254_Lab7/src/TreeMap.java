...
public class TreeMap<K,V> extends AbstractSortedMap<K,V> {
  ...
  private Position<Entry<K,V>> treeSearchLoop(K key) {
  ...
  public V get(K key) throws IllegalArgumentException {
    ...
    Position<Entry<K,V>> p = treeSearchLoop(key);
  ...
  public V put(K key, V value) throws IllegalArgumentException {
    ...
    System.out.println("=== Adding KV pair: " + newEntry + " to tree using treeSearchLoop (replaced recursive treeSearch ====");
    //Position<Entry<K,V>> p = treeSearch(root(), key);
    Position<Entry<K,V>> p = treeSearchLoop(key);
  ...
  public static void main (String[] args)
  {
      ...
      System.out.println("======== WARNING: Methods PUT, GET, and REMOVE are now using treeSearchLoop instead of treeSearch (recursive) ===========");
      ...
      System.out.println("Tree Search With Recursion for Key: 4\n" + map.treeSearch(map.root(),4).getElement());
      System.out.println("Tree Search With Loop for Key: 4\n" + map.treeSearchLoop(4).getElement());
      System.out.println("Tree Search With Loop for Key: 9\n" + map.treeSearchLoop(9).getElement());
