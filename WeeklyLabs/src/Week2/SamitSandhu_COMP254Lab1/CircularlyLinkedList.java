 ...
 */
package SamitSandhu_COMP254Lab1;
...
public class CircularlyLinkedList<E> {
  ...
  public String toString() {
    ...
    /**
     * Clone the list object that this method is called with.
     * Since its non-static, this clone method will auto belong to the current object.
     */
  public CircularlyLinkedList<E> clone() {
      CircularlyLinkedList<E> clonedList = new CircularlyLinkedList<>();

      if (isEmpty()) return clonedList;

      Node<E> walk = tail.getNext(); // head - since tail's next connects to the head (circular)

      //visit each node once and add into clonedList (last to keep same sequence)
      for (int i = 0; i < size; i++) {
          clonedList.addLast(walk.getElement());
          walk = walk.getNext();
      }
  ...
  public static void main(String[] args)
  {
      ...
      //Clone circularList
      CircularlyLinkedList clonedCL = circularList.clone();
