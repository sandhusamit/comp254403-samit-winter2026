...
public class DoublyLinkedList<E> {
    ...
    public void concat(DoublyLinkedList<E> L, DoublyLinkedList<E> M) {
        ...
        // Connect the node of L to the first node of M
        Node<E> lastL = L.trailer.getPrev();
        Node<E> firstM = M.header.getNext();

        //Last node of L now points to the first node of M
        //First node of M's prev reference now points to M's last node and next remains the same
        lastL.setNext(firstM);
        firstM.setPrev(lastL);

        //Create 3 DLL's in Driver - 1 blank and two filled (L and M) and call concat on it.

        // Update the new combined list's trailer to be M's trailer
...
//main method
  public static void main(String[] args)
  {
	  ...
	  System.out.println(L.last()); // this will connect to M's first
