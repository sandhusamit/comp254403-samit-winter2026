...
public class ArrayStack<E> implements Stack<E> {
  ...
  /**
   * Transfer stack elements into new stack - but insert elements
   * into new stack one by one from current stack, from top down (LIFO)
   */
public static <E> void transfer(ArrayStack<E> S, ArrayStack<E> T) {
  if (S.isEmpty())
    return;
  while (!S.isEmpty()) {
    E topElement = S.pop();
  ...
  System.out.println("Stack S has been transferred into Stack T");
}
